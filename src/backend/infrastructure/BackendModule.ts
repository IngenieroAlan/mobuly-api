...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      inject: [REPOSITORY_TOKENS.APPOINTMENT, REPOSITORY_TOKENS.CLIENT, REPOSITORY_TOKENS.SERVICE],
    },
    {
    ...
    },
    {
      ...
      useFactory: (repo: IAppointmentRepository) => new GetAppointmentUseCase(repo),
      inject: [REPOSITORY_TOKENS.APPOINTMENT],
    },
    {
      provide: ListAppointmentsUseCase,
      useFactory: (repo: IAppointmentRepository) => new ListAppointmentsUseCase(repo),
      inject: [REPOSITORY_TOKENS.APPOINTMENT],
    },
    {
      provide: DeleteAppointmentUseCase,
      useFactory: (repo: IAppointmentRepository) => new DeleteAppointmentUseCase(repo),
      inject: [REPOSITORY_TOKENS.APPOINTMENT],
    },
    {
      provide: GetAgendaViewUseCase,
      useFactory: (repo: IAppointmentRepository) => new GetAgendaViewUseCase(repo),
      inject: [REPOSITORY_TOKENS.APPOINTMENT],
    },
    {
      provide: APP_FILTER,
